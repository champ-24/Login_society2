...
public class AddShopStationary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_shop_stationary);
    ...
    private void Initialization() {
        ...
        activity_name.setText("Add Stationary Shop");
        add_shop=findViewById(R.id.add_shop);

        shop_name=findViewById(R.id.stationary_shop_name);
        shop_owner_name=findViewById(R.id.stationary_shop_owner_name);
        shop_contact=findViewById(R.id.stationary_shop_contact);
        shop_address=findViewById(R.id.stationary_shop_address);
    }
    ...
    public void AddShop(View view) {
        ...
        if (shop_name!=null && shop_owner_name!=null && shop_contact!=null && shop_address!=null){
            ...
            Toast.makeText(this,"Stationary Shop added",Toast.LENGTH_LONG).show();
            finish();
