...
public class AddShopElectronics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_shop_electronics);
        Initialization();
    }
    ...
    private void Initialization() {
        ...
        shop_name=findViewById(R.id.electronics_shop_name);
        shop_owner_name=findViewById(R.id.electronics_shop_owner_name);
        shop_contact=findViewById(R.id.electronics_shop_contact);
        shop_address=findViewById(R.id.electronics_shop_address);
    ...
    public void AddShop(View view) {
        if (shop_name!=null && shop_owner_name!=null && shop_contact!=null && shop_address!=null){
            ...
            Toast.makeText(this,"Electronics Shop added",Toast.LENGTH_LONG).show();
            finish();
