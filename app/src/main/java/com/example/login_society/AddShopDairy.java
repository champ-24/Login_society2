...
public class AddShopDairy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_shop_dairy);
    ...
    private void Initialization() {
        ...
        shop_name=findViewById(R.id.dairy_shop_name);
        shop_owner_name=findViewById(R.id.dairy_shop_owner_name);
        shop_contact=findViewById(R.id.dairy_shop_contact);
        shop_address=findViewById(R.id.dairy_shop_address);
    }
    ...
    public void AddShop(View view) {
        ...
        if (shop_name!=null && shop_owner_name!=null && shop_contact!=null && shop_address!=null){
            ...
            Toast.makeText(this,"Dairy Shop added",Toast.LENGTH_LONG).show();
            finish();
