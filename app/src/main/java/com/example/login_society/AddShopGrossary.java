...
public class AddShopGrossary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_shop_glossary);
    ...
    private void Initialization() {
        ...
        activity_name.setText("Add Grossary Shop");
        add_shop=findViewById(R.id.add_shop);

        shop_name=findViewById(R.id.glossary_shop_name);
        shop_owner_name=findViewById(R.id.glossary_shop_owner_name);
        shop_contact=findViewById(R.id.glossary_shop_contact);
        shop_address=findViewById(R.id.glossary_shop_address);
    }
    ...
    public void AddShop(View view) {
        ...
        if (shop_name!=null && shop_owner_name!=null && shop_contact!=null && shop_address!=null){
            ...
            Toast.makeText(this,"Grossary Shop added",Toast.LENGTH_LONG).show();
            finish();
